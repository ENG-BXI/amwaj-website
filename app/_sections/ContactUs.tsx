...
const ContactUs = () => {
  return (
    <section className='section'>
      <h2 className='section__title text-[120px]!'>تواصل معنا CONTACT US</h2>
      <p className='text-secondary font-bold  text-center mb-10'>ابدأ خطوتك الأولى نحو مشروع ناجح—تواصل معنا اليوم.</p>
      <form className=' mx-auto py-5 px-20 w-300 flex flex-col justify-center items-center bg-[#204C4C]/40 border-2 border-secondary rounded-4xl' action=''>
        <div className='flex w-full gap-x-10 mb-7'>
